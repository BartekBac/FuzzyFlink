...
import fuzzy.operators.interfaces.IFuzzyJoin;
...
public class FuzzyJoin<T, K> implements IFuzzyJoin<T, K> {
    public DataStream transform(DataStream<T> input, DataStream<K> joinStream, KeySelector<T, String> personKeySelector, KeySelector<K, String> walkVelocityKeySelector, JoinFunction joinFunction) {
        ...
        // Pojawia się błąd:
        //   Exception in thread "main" org.apache.flink.api.common.functions.InvalidTypesException: Type of TypeVariable 'T' in 'class fuzzy.operators.FuzzyNumericJoin' could not be determined.
