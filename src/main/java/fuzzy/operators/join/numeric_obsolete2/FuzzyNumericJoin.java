...
public class FuzzyNumericJoin<T, K> implements IFuzzyNumericJoin<T, K> {
    public DataStream transform(DataStream<T> input, DataStream<K> joinStream, KeySelector<T, Boolean> objectKeySelector, KeySelector<K, Boolean> joinedKeySelector, JoinFunction joinFunction) {
